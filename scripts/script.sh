...
# 
#  A instancia master recebe um diretorio para o ansible
#
# ------------------------- Variables ----------------------------- #
...
PATH_SCRIPT_ANSIBLE="./scripts/ansible/"
COUNT=0
# ------------------------------------------------------------------ #
# ---------------------------- Functions --------------------------- #
insert_files_in_instance_master(){
   echo "------------ master ---------------"
   scp -r $PATH_SCRIPT_ANSIBLE $INSTANCE_NAME@$VALUE:/home/$INSTANCE_NAME
